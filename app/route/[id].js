      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.detailsCard}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>
              {route.start_location ? 
                JSON.parse(route.start_location).latitude.toFixed(6) + ', ' + 
                JSON.parse(route.start_location).longitude.toFixed(6) 
              : 'Unknown'}
            </Text>
          </View>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>
              {route.end_location ? 
                JSON.parse(route.end_location).latitude.toFixed(6) + ', ' + 
                JSON.parse(route.end_location).longitude.toFixed(6) 
              : 'Unknown'}
            </Text>
          </View>
